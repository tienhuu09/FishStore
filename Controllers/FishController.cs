...
namespace FishStore.Controllers
{
    public class FishController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Genre,Gender,Price,ProfilePicture")] Fish fish)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Genre,Gender,Price,ProfilePicture")] Fish fish)
        {
            if (id != fish.Id)
            {
                return NotFound();
